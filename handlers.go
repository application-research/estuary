...
func (cm *ContentManager) addDatabaseTrackingToContent(ctx context.Context, cont uint, dserv ipldformat.NodeGetter, bs blockstore.Blockstore, root cid.Cid) error {
...
func (cm *ContentManager) addDatabaseTracking(ctx context.Context, u *User, dserv ipldformat.NodeGetter, bs blockstore.Blockstore, root cid.Cid, fname string, replication int) (*Content, error) {

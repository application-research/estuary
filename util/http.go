...
const (
	...
	ERR_AUTH_MISSING_BEARER_DETAILS = "Unsupported authorization scheme: Bearer is a required prefix. The Authorization HTTP Header should be in the format \"Authorization: Bearer YOUR_API_KEY_HERE\"."
	ERR_INVALID_AUTH_DETAILS        = "Invalid Auth: An Invalid API Key was specified. The Authorization HTTP Header should be in the format \"Authorization: Bearer YOUR_API_KEY_HERE\". You have the Bearer prefix but your API Key is empty or missing."
)

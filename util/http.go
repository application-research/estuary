...
const (
	...
	/* SIWE Errors */
	ERR_INVALID_SIWE_LOGIN_BODY = "ERR_INVALID_SIWE_LOGIN_BODY"

	ERR_NO_NONCE_SET    = "ERR_NO_NONCE_SET"
	ERR_NO_SIWE_MESSAGE = "ERR_NO_SIWE_MESSAGE"

	ERR_INVALID_NONCE          = "ERR_INVALID_NONCE"
	ERR_INVALID_SIWE_MESSAGE   = "ERR_INVALID_SIWE_MESSAGE"
	ERR_INVALID_SIWE_SIGNATURE = "ERR_INVALID_SIWE_SIGNATURE"

	// For Populated Uploads:
	ERR_BLAKE3_HASH_MISSING  = "ERR_BLAKE3_HASH_MISSING"
	ERR_BLAKE3_HASH_MISMATCH = "ERR_BLAKE3_HASH_INVALID"
	ERR_DEAL_ID_MISSING      = "ERR_DEAL_ID_MISSING"
)
